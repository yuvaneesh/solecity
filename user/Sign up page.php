            ...
            <div class="panels__container">
                ...
                <div class="panel">
                    <div class="panel__content">
                        ...
                        <h3>One of us ?</h3>
                        <p>What are you waiting for? Login in now!</p>
                        <br/>
                        <a href="Login page.php">
                            <button class="login__button transparent" id="sign-in-btn">Login in</button>
                        </a>
                    </div>
                    ...
                    <br/>
                    <br/>
                    <img src="img/orange.png" class="image" alt="shoe" />
                </div>
